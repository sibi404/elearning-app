...
const CourseCard = ({ title, teacher, description, duration, thumbnail, studentCount }) => {
    return (
        <div className="course-card mt-3 container-border max-h-[420px] w-full lg:w-[32%] overflow-hidden transition-all duration-100">
            ...
            <div className='px-5 py-4'>
                ...
                <p className='text-faded-text text-sm line-clamp-2'>
                    {description}
                </p>
                ...
                <div className='py-3 text-faded-text text-sm flex justify-start gap-5'>
                    ...
                    <p className='flex items-center gap-1'><Users size={14} />{studentCount}</p>
