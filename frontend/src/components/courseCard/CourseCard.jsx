...
const CourseCard = () => {
    return (
        <div className="course-card mt-3 container-border w-full lg:w-[32%] overflow-hidden transition-all duration-100">
            ...
            <div className='px-5 py-4'>
                <h2 className='font-semibold text-lg text-text-black'>Linux for beginner</h2>
                <p className='text-faded-text text-sm py-2'>by Sara Johnson</p>
                <p className='text-faded-text text-sm'>
                ...
                <div className='py-3 text-faded-text text-sm flex justify-start gap-5'>
                    <p className='flex items-center gap-1'><Clock size={14} />12 hours</p>
