...
import AddLesson from "../pages/courseDetail/LessonTab/addLesson/AddLesson";
import AddAssignment from "../pages/courseDetail/assignmentTab/addAssignment/AddAssignment";
